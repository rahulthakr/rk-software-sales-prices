...
class Thakur_ProductOptions_Block_Adminhtml_Product_Edit_Tab_CustomOptions_Options {
  ...
  public function __construct(){
    ...
    $this->_option = new Thakur_ProductOptions_Model_Option(); 	
  }
  ...
  public function getOptionDataJson(){
    ...
    foreach ($options as $option){
      ...
      $data['optionsData'][$oId] = array(
        ...
        'hide_price' => (int) $option['hide_price'],
  ...
  public function toHtml(){
     include_once(Thakur_PO()->getPluginPath() . 'view/adminhtml/templates/product/edit/tab/customoptions/options.php');
  }
